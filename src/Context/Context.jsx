...
export let UseEmployeeData = () =>{
       return useContext(EmployeeContext);
}

export let EmployeeProvider = (props)=>{
    let [employeData , setEmployeData] = useState([{"id":1,"first_name":"Jaymee","last_name":"Imm","email":"jimm0@craigslist.org","gender":"Genderqueer","age":80},
    ...
    return(
        <EmployeeContext.Provider value={{employeData , setEmployeData , teamData , setTeamData}}>
          {props.children}
